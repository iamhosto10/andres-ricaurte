        ...
        >
          <div className="lg:col-span-2 primary-gradient p-12 flex flex-col justify-center">
            ...
            <p className="text-on-primary-container/80 mb-8 font-body leading-relaxed text-lg">
              Hablemos de Oportunidades. Trabajemos juntos para escalar tu facturación con IA.
            </p>
            ...
            <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  <label htmlFor="name" className="text-[10px] uppercase tracking-widest text-on-surface-variant font-bold ml-1">
                    Nombre Completo
                  </label>
                  <input
                    id="name"
                ...
                <div className="space-y-2">
                  <label htmlFor="email" className="text-[10px] uppercase tracking-widest text-on-surface-variant font-bold ml-1">
                    Correo Electrónico
                  </label>
                  <input
                    id="email"
              ...
              <div className="space-y-2">
                <label htmlFor="industry" className="text-[10px] uppercase tracking-widest text-on-surface-variant font-bold ml-1">
              ...
              <p className="text-center text-xs text-on-surface-variant">Disponibilidad limitada para ciclos de consultoría mensual.</p>
            </form>
          </div>
        </motion.div>
      </div>
