...
const testimonials: Testimonial[] = [
  {
    quote: '"Tiene una manera muy clara de enseñar lo que facilita la comprensión y aplicación inmediata de sus metodologías. Gracias a su efectividad, hemos logrado atraer más seguidores y posicionar mejor la empresa."',
    name: "Daniela Vélez",
    role: "Ventas Hotel Vajamar - Valledupar",
    avatarUrl: "https://lh3.googleusercontent.com/aida/ADBb0uhhM7Wv_X-XzL2-Y6-Gz_Z7Y_R8F-uB8P-Q-H-G-G-G"
  },
  {
    quote: '"Implementar el sistema de ventas con IA cambió las reglas del juego. Nuestro tiempo de respuesta bajó drásticamente y la conversión aumentó en un 32% en el primer trimestre."',
    ...
    >
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <span className="text-xs text-on-surface-variant uppercase tracking-widest">{testimonial.role}</span>
        </div>
      </div>
    </motion.div>
  );
