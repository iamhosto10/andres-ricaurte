...
const services: Service[] = [
  {
    ...
    description: "Automatiza tu proceso de ventas con IA: Capta leads calificados, haz seguimiento y convierte más clientes con embudos avanzados."
  },
  {
    icon: "groups",
    title: "Consultoría 1:1",
    description: "Para dueños de negocios que buscan claridad y resultados. Implementamos estrategias para escalar tu facturación rápidamente."
  },
  {
    icon: "verified_user",
    title: "Reputación Digital",
    description: "Exclusivo para negocios que quieren aparecer en Google, ChatGPT y otros motores de IA, ganando visibilidad en su sector."
  },
  {
    icon: "school",
    title: "Capacitaciones",
    description: "Sesiones de mentoría grupales para empresarios y equipos que quieren aprender a optimizar procesos y crecer exponencialmente."
  },
  {
    icon: "chat",
    title: "Ventas por Instagram y WhatsApp",
    description: "Implementa una estrategia en tu negocio que te permita cerrar más ventas por canales de mensajería directa de forma eficiente."
  },
  {
    icon: "share",
    title: "Gestión de Redes Sociales",
    description: "Pensado para negocios que necesitan visibilidad y clientes constantes a través de Campañas Digitales y presencia profesional."
  }
];
