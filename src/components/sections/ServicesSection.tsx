...
const services: Service[] = [
  {
    icon: <span className="material-symbols-outlined text-primary text-3xl">dynamic_feed</span>,
    title: "Sistema de Ventas",
    description: "Automatizamos tu embudo desde la captación hasta el cierre con agentes de IA inteligentes.",
  },
  {
    icon: <span className="material-symbols-outlined text-primary text-3xl">person_search</span>,
  ...
  {
    icon: <span className="material-symbols-outlined text-primary text-3xl">stars</span>,
    title: "Reputación Digital",
    description: "Domina Google y ChatGPT. Haz que hablen bien de ti donde tus clientes están buscando.",
  },
  {
    icon: <span className="material-symbols-outlined text-primary text-3xl">chat</span>,
          ...
          {services.map((service, index) => (
            ...
            >
              ...
              <button className="text-primary font-bold text-sm flex items-center gap-2 group tracking-tight">
                Saber más <span className="material-symbols-outlined text-lg group-hover:translate-x-1 transition-transform">arrow_forward</span>
              </button>
            </motion.div>
          ))}
        </div>
