      ...
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
        <div className="order-2 md:order-1">
          ...
          >
            <img
              ...
              src="https://andresricaurte.com/wp-content/uploads/2025/09/IMG_20250912_143339.png"
            />
          </FadeIn>
        </div>
        <div className="order-1 md:order-2">
          ...
          >
            ...
            <p>
              Mi trayectoria incluye el desarrollo de un exitoso{" "}
              <strong>blog financiero</strong> y mi invaluable experiencia en{" "}
              <strong>Seeed</strong>, donde aprendí de primera mano qué funciona
              y qué no en entornos digitales de alto crecimiento.
            </p>
            <p>
