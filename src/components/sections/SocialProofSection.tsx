    ...
    <section className="py-16 bg-surface-container-low border-y border-slate-100">
      <div className="max-w-7xl mx-auto px-6 text-center">
        ...
        <div className="flex flex-col gap-12 items-center">
          <div className="flex flex-wrap justify-center items-center gap-12 md:gap-24 opacity-30 grayscale contrast-125 transition-opacity hover:opacity-100">
          ...
          <div className="max-w-4xl mx-auto w-full h-64 rounded-2xl overflow-hidden grayscale opacity-40 hover:opacity-80 transition-all soft-shadow relative">
            <Image
              alt="Team"
